...
#define VEC2_COPY(src, dest)   ( (dest)[0] = (src)[0], (dest)[1] = (src)[1] )
#define VEC2_NEGATE(src, dest) ( (dest)[0] = -((src)[0]), (dest)[1] = -((src)[1]) )
#define VEC2_SET(dest, x, y)   ( (dest)[0] = (x), (dest)[1] = (y) )
#define VEC2_SCALE(src, scale, dest) ((dest)[0] = (src)[0] * (scale), (dest)[1] = (src)[1] * (scale))
#define VEC2_NORMALIZE2(v, dest) \
		{ \
...
#define VEC2_ADD(src1, src2, dest) ( (dest)[0] = (src1)[0] + (src2)[0], (dest)[1] = (src1)[1] + (src2)[1] )
#define VEC2_SUB(src1, src2, dest) ( (dest)[0] = (src1)[0] - (src2)[0], (dest)[1] = (src1)[1] - (src2)[1] )
